...
/**
 * @see net.openhft.collections.Replicators
 * @see net.openhft.collections.SharedHashMapBuilder#addReplicator(Replicator)
 */
public abstract class Replicator {
     ...
     */
    protected abstract Closeable applyTo(SharedHashMapBuilder builder,
